          ...
          public void apply(final JvmOperation it) {
            ...
            final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
                public void apply(final ITreeAppendable it) {
                  it.trace(e);
                  StringConcatenation _builder = new StringConcatenation();
                  _builder.append("String query = \"Select m From ");
                  String _simpleName = t.getSimpleName();
                  _builder.append(_simpleName, "");
                  _builder.append(" m Where\";");
                  _builder.newLineIfNotEmpty();
                  _builder.append("for(int i = 0 ; i < pairs.size() ; i++) {");
                  _builder.newLine();
                  _builder.append("\t");
                  _builder.append("query += \" m.\" + pairs.get(i).getKey() +  \" = \'\" + pairs.get(0).getValue() + \"\'\";");
                  _builder.newLine();
                  _builder.append("\t");
                  _builder.append("if(i < pairs.size() - 1) {");
                  _builder.newLine();
                  _builder.append("\t\t");
                  _builder.append("query += \" and\";");
                  _builder.newLine();
                  _builder.append("\t");
                  _builder.append("}");
                  _builder.newLine();
                  ...
                  String _simpleName_1 = t.getSimpleName();
                  _builder.append(_simpleName_1, "");
                  _builder.append("> q = _entityManager.createQuery(query, ");
                  String _simpleName_2 = t.getSimpleName();
                  _builder.append(_simpleName_2, "");
                  _builder.append(".class);");
                  _builder.newLineIfNotEmpty();
                  ...
                  String _simpleName_3 = t.getSimpleName();
                  _builder.append(_simpleName_3, "");
                  _builder.append("> _results = q.getResultList();");
                  _builder.newLineIfNotEmpty();
                  _builder.append("_entityManager.getTransaction().commit();");
                  _builder.newLine();
                  _builder.append("_entityManager.close();");
