package org.eclipse.xtext.services.serializer;
...
public class AbstractServicesSemanticSequencer extends AbstractSemanticSequencer {
	 ...
	 *         (requires+=RequireDeclaration requires+=RequireDeclaration*)? 
	 *         services+=Service*
	 *     )
	 */
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ServicesPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ServicesPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
