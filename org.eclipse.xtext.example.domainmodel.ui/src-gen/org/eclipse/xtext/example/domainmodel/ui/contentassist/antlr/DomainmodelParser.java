		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyAccess().getMappedByAssignment_3_1(), "rule__Property__MappedByAssignment_3_1");
					put(grammarAccess.getPropertyAccess().getReflectsOnAssignment_4_1(), "rule__Property__ReflectsOnAssignment_4_1");
